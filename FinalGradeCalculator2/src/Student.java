...
public class Student {
	...
	public void readGradeFile(String fileName) throws FileNotFoundException
	{
		try 
		{
			...
			String section = ""; // initializes the section string		
			...
			while (fileScanner.hasNextLine())
			{
				...
				// checks to see which section type it is
				switch(splitLine[0])
				{
				...
				// adds the grade based on section type
				addGrade(section, Double.parseDouble(splitLine[1]));
			}
